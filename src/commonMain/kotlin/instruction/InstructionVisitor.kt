...
abstract class AnyInstructionVisitor : CompleteInstructionVisitor {
    ...
    override fun visitLegacyTry(op: Op, blockType: BlockType): LegacyTryBlockVisitor = visit(op).let { TryBlock() }
    override fun visitEnd() {}

    inner class NestedBlock : CompleteInstructionVisitor by this {
        override fun visitEnd() {
            visit(Op.END)
        }
    }

    inner class IfBlock : CompleteInstructionVisitor by this, IfBlockVisitor {
    ...
    inner class TryBlock : CompleteInstructionVisitor by this, LegacyTryBlockVisitor {
